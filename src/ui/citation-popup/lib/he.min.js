...
!(function (r) {
    ...
    var c = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
        ...
        D = function (r, e) {
            ...
            var a,
                t = {};
            for (a in e) t[a] = w(r, a) ? r[a] : e[a];
            return t;
        },
        y = function (r, e) {
            var a = "";
            return (55296 <= r && r <= 57343) || 1114111 < r
                ? (e &&
                      x(
                  ...
                  "�")
                : w(m, r)
                ? (e && x("disallowed character reference"), m[r])
                : (e &&
                      (function (r, e) {
                    ...
                    ? ((r = r.replace(l, function (r) {
                      ...
                      t &&
                          (r = r
                              ...
                              .replace(/&#x66;&#x6A;/g, "&fjlig;")),
                      t &&
                          (r = r.replace(n, function (r) {
                              return "&" + p[r] + ";";
                          })))
                    : t
                    ? (o ||
                          (r = r.replace(d, function (r) {
                              return "&" + p[r] + ";";
                          })),
                      (r = (r = r
                          .replace(/&gt;\u20D2/g, "&nvgt;")
    ...
    var L = function (r, f) {
        var b = (f = D(f, L.options)).strict;
        return (
            b && s.test(r) && x("malformed character reference"),
            r.replace(u, function (r, e, a, t, o, s, u, c, l) {
                var i, n, p, d, g, m;
                return e
                    ? h[(g = e)]
                    : a
                    ? ((g = a),
                      (m = t) && f.isAttributeValue
                          ? (b &&
                                "=" == m &&
    ...
    if (
        ...
        if (a) a.exports = S;
        else for (var C in S) w(S, C) && (e[C] = S[C]);
    else r.he = S;
})(this);
//# sourceMappingURL=/sm/79062eab3beb39648091b697dbbb8a2ee88174ffd8c7a989578d8eee0d1084c1.map
